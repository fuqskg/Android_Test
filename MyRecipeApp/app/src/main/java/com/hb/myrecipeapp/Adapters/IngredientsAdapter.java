...
import com.hb.myrecipeapp.Models.ExtendedIngredient;
...
//객체만들기
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("https://spoonacular/cdn/ingredients_100x100/" + list.get(position).image).into(holder.imageView_ingredients);
    }
